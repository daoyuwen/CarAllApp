...
//
//import com.alap.app3.MainActivity;
//import com.alap.app3.R;
//
...
//    String isPrivacy = DataUtils.get(HelpActivity.this, "privacy", "0").toString();
//    String isPolicy = DataUtils.get(HelpActivity.this, "policy", "0").toString();
//
...
//                    prviacyType = 2;
//                    //保存隐私同意状态
//                    DataUtils.put(HelpActivity.this, "privacy", "1");
//                    //显示下一个隐私内容
//                    showPrivacy("policy.txt", "使用条款");
//                } else if (prviacyType == 2) {
//                    DataUtils.put(HelpActivity.this, "policy", "1");
//                    //两个隐私内容都确定后，开始执行下一步
//                }
//
//            }
